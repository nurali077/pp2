...
# Load 
background = pygame.image.load(r"C:\Users\sotsi\pp2\Lab9\Snake\bg.jpg")
theme_music = pygame.mixer.Sound(r"C:\Users\sotsi\pp2\Lab9\Snake\music.mp3")
...
def handle_food_collision():
    ...
    if current_pos[0] == [grape_x, grape_y]:
        ...
        food_score += weight
        weight = random.randint(1, 3)
        play_music(r"C:\Users\sotsi\pp2\Lab9\Snake\food.mp3")
...
def game_over():
    if current_pos[0] in walls:
        theme_music.stop()
        play_music(r"C:\Users\sotsi\pp2\Lab9\Snake\gameover.mp3")
...
while not done:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            play_music(r"C:\Users\sotsi\pp2\Lab9\Snake\move.mp3")
