...
class coins( pygame.sprite.Sprite ):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load( r"C:\Users\sotsi\pp2\Lab8\Racer\coin1.png" )
...
bg = pygame.image.load( r"C:\Users\sotsi\pp2\Lab8\Racer\AnimatedStreet.png" )
...
while not done:
    ...
    if c.rect.colliderect( p.rect ):
        count_of_coins +=1 
        pygame.mixer.music.load( r"C:\Users\sotsi\pp2\Lab8\Racer\coin.mp3" )
    ...
    if p.rect.colliderect(e.rect):
        ...
        pygame.mixer.music.load( r"C:\Users\sotsi\pp2\Lab8\Racer\crash.wav" )
        pygame.mixer.music.play(1)
